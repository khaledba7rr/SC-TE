...
const CartItems: React.FC<{ itemsLength: number }> = ({ itemsLength }) => {
  ...
  return (
    <>
            ...
            return (
              <>
                <div
                  ...
                  className="d-flex mb-2 mt-2 row align-items-stretch"
                >
                  <div className="col-5">
      ...
      <div className="total-section d-flex justify-content-between mt-2">
        ...
        <p data-testid="cart-total" className="total-price">
          {' '}
